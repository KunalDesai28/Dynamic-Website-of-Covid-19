...
if(isset($_POST['login']))
  {
    ...
    if($ret>0){
      $_SESSION['aid']=$ret['ID'];
     header('location:new-user-testing.php');
    }
    else{
...
<head>
    ...
    <title>Covid 19 Testing Management System | Login</title>
...
<body style="background-color:#a37e03">
...
<form name="login" method="post">
                                    ...
                                    <form class="user">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="username" 
                                                id="username" placeholder="Enter Login ID" required="true">
                                        </div>
                                        <div class="form-group">
                        ...
                        <input type="submit" name="login" class="btn btn-primary btn-user btn-block" value="login">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="password-recovery.php" style="font-weight:bold">Forget Password?</a>
